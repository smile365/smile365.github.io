---
title: "什么是 CUDA"
keywords: ["CUDA 是什么", "GPU 编程", "NVIDIA CUDA 架构", "CPU vs GPU", "并行计算"]
tags: ["CUDA", "GPU", "NVIDIA"]
description: "CUDA是NVIDIA推出的统一计算架构，本文用大白话解释CPU和GPU的区别以及CUDA如何让程序员轻松操控GPU进行并行计算。"
heading: "CUDA是什么：GPU编程架构详解"
categories: ["code"]
