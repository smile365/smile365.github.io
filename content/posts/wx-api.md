...
keywords: ["教程", "微信公众号管理系统", "部署", "管理微信公众号", "wx api", "api", "utf8mb4", "src", "wx manage"]
tags: ["教程", "微信公众号管理系统", "部署", "管理微信公众号", "wx api", "api", "utf8mb4", "src"]
description: "微信公众号管理系统，包含公众号菜单管理、自动回复、素材管理、模板消息、粉丝管理️等功，适合已经认证成功的微信订阅号，个人非认证号暂不支持（没有api的权限，因此无法部署成功）。"
categories: ["code"]
