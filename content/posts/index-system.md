...
keywords: ["教程", "百度指数", "微信指数", "开发设计一套百度", "微信", "淘宝指数产品", "boss", "ceo", "index", "system"]
tags: ["教程", "百度指数", "微信指数", "开发设计一套百度", "微信", "淘宝指数产品", "boss", "ceo"]
description: "公司有一款舆情分析的产品，里面有一个功能是**智能分析**。功能有点类似百度指数。前两天大boss（俗称ceo）在会上反馈公司的智能分析功能出不来结果，关键时刻掉链子。"
categories: ["code"]
