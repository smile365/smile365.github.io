---
title: "Selenium 与 PhantomJS 的使用"
keywords: ["Selenium 教程", "PhantomJS 使用", "Python 自动化测试", "Chrome 驱动", "爬虫自动化"]
tags: ["selenium", "PhantomJS", "自动化测试"]
description: "Selenium 网页自动化测试工具与 PhantomJS 无头浏览器的安装和使用教程，含 Chrome 和服务器部署方案。"
categories: ["code"]
